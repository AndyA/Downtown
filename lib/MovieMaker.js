...
module.exports = (function() {
  ...
  exports.util = {
    ...
    defineClass: function() {
      ...
      if (args.length == 0) throw new Error("Missing argument to defineClass");
      var klass = args[0] instanceof Function ? args.shift() : function() {};
      if (args[0] instanceof Array) { // class methods
        var class_methods = args.shift();
        var mixin_args = class_methods.slice();
  ...
  exports.RampProperty.prototype = exports.util.mixin(new exports.DynamicPropertyBase(), {
  ...
  exports.util.mixin(ClipBase.prototype, dynamicPropertyMixin, {
