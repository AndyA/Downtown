module.exports = (function() {
  ...
  exports.RampProperty.prototype.evaluate = function(framenum, portion) {
  ...
  ClipBase.prototype.bindParameters = function(params, defaults) {
    var keys = Object.keys(defaults);
    for (var i = 0; i < keys.length; i++) {
      var key = keys[i];
      var val = params.hasOwnProperty(key) ? params[key] : defaults[key];
  ...
  //////////////////
  //
  exports.TransformClip = function(clip, props) {
    this.clip = clip;
