...
module.exports = (function() {
          ...
          (function() {
            ...
            Object.defineProperty(self, name, {
              get: function() {
                ...
                if (state.hasOwnProperty('cache') && contextEqual(ctx, state.ctx)) return state.cache;
  ...
  //////////////////
  //
  exports.TrigProperty = defineClass(function() {},
  new exports.DynamicPropertyBase(), {
    evaluate: function(ctx) {
      return ctx.portion;
    }
